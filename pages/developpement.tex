...
Le développement de notre projet repose sur l’articulation de deux composants logiciels bien distincts, chacun répondant à des besoins spécifiques et complémentaires. D’une part, nous avons conçu un outil de génération de terrain procédural développé en \textbf{C++}. Ce programme est chargé de produire automatiquement des cartes de jeu structurées, de taille paramétrable, intégrant différents \textit{biomes} (zones géographiques thématiques telles que forêt, montagne, désert, etc.) ainsi qu’un positionnement intelligent et configurable des ressources (comme le bois, la pierre ou l’or).
