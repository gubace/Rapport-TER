\subsection{\textit{AutoBiomes: procedural generation of multi-biome landscapes (2020)} \cite{Autobiome}}
...
\end{figure}
    ...
    Le terrain est Généré à l’aide de fonctions de bruit, notamment du bruit simplex \cite{simplex} multi-octaves. Cela permet une création rapide et flexible d’un terrain général, sans se soucier des détails réalistes dès cette étape. L'utilisateur peut ajuster les paramètres, comme le nombre d'octaves ou le seuil de niveau de la mer.
